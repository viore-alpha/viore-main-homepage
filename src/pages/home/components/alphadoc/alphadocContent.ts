...
export const ALPHADOC_CONTENT = {
  ko: {
    ...
    headline: '의료인들의 하루를 같이하는 알파닥',
    body: '알파닥은 의사들의 하루의 시작과 마무리를 같이하는 동반자에요.',
    ctaLabel: '알파닥 시작하기',
    note: '현재는 한국어만 지원하며 영문 버전은 준비 중에 있습니다.',
    demoTitle: '알파닥 데모',
    ...
    workflows: [
      {
        ...
        title: '임상용 알파닥AI 엔진',
        subtitle: '근거, 문서, SOAP를 한 흐름으로',
        description: '진료 질문에서 근거 확인, 문서·이미지 해석, SOAP 초안까지 이어지는 임상 AI 흐름입니다.',
        bullets: [
          { icon: 'ri-links-line', text: '최신 진료 지침 및 근거 기반 추론' },
          { icon: 'ri-image-2-line', text: '문서, 이미지 기반 추론' },
          { icon: 'ri-file-list-3-line', text: 'SOAP 작성' },
          { icon: 'ri-search-eye-line', text: '검색으로 답변의 최신성 확인' },
        ],
      ...
      },
      {
        ...
        title: '의료 정보 패널 알파윙',
        subtitle: '뉴스, 논문, 커뮤니티를 곁에 두는 패널',
        description: '진료 전후에 필요한 의료 업데이트와 동료 의료인의 현장 맥락을 같은 화면에서 확인합니다.',
        bullets: [
          { icon: 'ri-newspaper-line', text: '선별된 핵심 의료 뉴스 큐레이션 및 실시간 뉴스' },
          { icon: 'ri-book-open-line', text: '글로벌 논문 및 가이드라인 허브' },
          { icon: 'ri-team-line', text: '알파닥 유저들만의 익명 커뮤니티' },
          { icon: 'ri-global-line', text: '추후 글로벌 기능 출시 예정' },
        ],
      ...
      },
      {
        ...
        title: '의료인을 위한 위젯바',
        subtitle: '날짜와 계산 도구를 상시 접근',
        description: '의료인이 매일 확인하는 날짜, 계산기, 편의 기능을 진료 흐름 옆에 작게 고정합니다.',
        bullets: [
          { icon: 'ri-calendar-line', text: '날짜 표기용 캘린더' },
          { icon: 'ri-calculator-line', text: '의료계산기 및 여러 편의 기능들 추가 예정' },
        ],
  ...
  en: {
    assets: ALPHADOC_ASSETS,
    headline: 'Alphadoc works with healthcare professionals all day',
    body: 'Alphadoc is a daily companion from the first clinical check to the end-of-day wrap-up.',
    ctaLabel: 'Start Alphadoc',
    note: 'Korean is currently supported. The English version is in preparation.',
