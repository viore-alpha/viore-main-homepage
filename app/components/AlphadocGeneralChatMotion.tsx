  ...
  return (
    ...
    >
      <div className="ap-general-window" aria-hidden="true">
        <header className="ap-general-topbar">
          <span className="ap-general-brand">
            <img src="/brand/alphadoc-alpha.png" alt="" width="419" height="365" decoding="async" />
            <strong>{language === "ko" ? "알파닥" : "Alphadoc"}</strong>
          </span>
          <span className="ap-general-workspace-label">{copy.workspace}</span>
        </header>

        <div className="ap-general-stage">
          <section className="ap-general-conversation">
            ...
            <article className="ap-general-answer">
              <span className="ap-general-answer-mark">
                <img src="/brand/alphadoc-alpha.png" alt="" width="419" height="365" decoding="async" />
              </span>
              <div>
        ...
        <div className="ap-general-composer-dock">
          ...
          <div className="ap-general-composer">
            <span className="ap-general-attach">
              <img src={`${ALPHADOC_ASSET_ROOT}/brand/feature-icons/chat/attach/logo.svg`} alt="" width="28" height="28" decoding="async" />
            </span>
            ...
            <span className="ap-general-send">{copy.send}</span>
          </div>
        </div>
      </div>
    </div>
